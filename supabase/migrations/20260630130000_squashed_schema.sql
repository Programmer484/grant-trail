-- ==========================================
-- Squashed schema baseline (2026-06-30)
-- ==========================================
-- Single consolidated baseline that REPLACES the 13 schema migrations
-- (initial_schema .. rls_fix_insert_privilege_escalation). Generated via
-- `supabase db dump --local --schema public` of the local DB after all of those
-- migrations were applied, so the resulting public schema (tables, functions,
-- triggers, table GRANTs, and RLS policies) is identical to the pre-squash state.
--
-- Companion file 20260630140000_bootstrap_data.sql holds the seed/config rows
-- (tenant, settings, platform_settings, storage buckets) the dropped data
-- migrations used to insert. Storage.objects RLS policies live at the BOTTOM of
-- this file (a public-schema dump does not capture the storage schema).
--
...
CREATE TABLE IF NOT EXISTS "public"."budget_items" (
    ...
    CONSTRAINT "budget_items_status_check" CHECK ((("status")::"text" = ANY (ARRAY[('pending'::character varying)::"text", ('approved'::character varying)::"text", ('rejected'::character varying)::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."fiscal_agent_listings" (
    ...
    CONSTRAINT "fiscal_agent_listings_verification_check" CHECK ((("verification")::"text" = ANY (ARRAY[('pending'::character varying)::"text", ('verified'::character varying)::"text", ('rejected'::character varying)::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."grant_record" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "grant_record_status_check" CHECK ((("status")::"text" = ANY (ARRAY[('pending'::character varying)::"text", ('approved'::character varying)::"text", ('needs_changes'::character varying)::"text", ('rejected'::character varying)::"text"])))
);
...
CREATE POLICY "Owners can insert their listing" ON "public"."fiscal_agent_listings" FOR INSERT WITH CHECK (("public"."has_premium_membership"() AND ("owner_user_id" IN ( SELECT "users"."id"
   FROM "public"."users"
  WHERE ("users"."user_id" = "auth"."uid"()))) AND ("tenant_id" = "public"."current_tenant_id"())));



CREATE POLICY "Owners can triage their inquiries" ON "public"."sponsorship_inquiries" FOR UPDATE USING (("public"."has_premium_membership"() AND ("listing_id" IN ( SELECT "l"."id"
   FROM ("public"."fiscal_agent_listings" "l"
     JOIN "public"."users" "u" ON (("l"."owner_user_id" = "u"."id")))
  WHERE ("u"."user_id" = "auth"."uid"()))))) WITH CHECK (("public"."has_premium_membership"() AND ("listing_id" IN ( SELECT "l"."id"
   FROM ("public"."fiscal_agent_listings" "l"
     JOIN "public"."users" "u" ON (("l"."owner_user_id" = "u"."id")))
  WHERE ("u"."user_id" = "auth"."uid"())))));
...
CREATE POLICY "Owners can update their listing" ON "public"."fiscal_agent_listings" FOR UPDATE USING (("public"."has_premium_membership"() AND ("owner_user_id" IN ( SELECT "users"."id"
   FROM "public"."users"
  WHERE ("users"."user_id" = "auth"."uid"()))) AND ("tenant_id" = "public"."current_tenant_id"()))) WITH CHECK (("public"."has_premium_membership"() AND ("owner_user_id" IN ( SELECT "users"."id"
   FROM "public"."users"
  WHERE ("users"."user_id" = "auth"."uid"()))) AND ("tenant_id" = "public"."current_tenant_id"())));
...
CREATE POLICY "Owners can view their inquiries" ON "public"."sponsorship_inquiries" FOR SELECT USING ((("listing_id" IN ( SELECT "l"."id"
   FROM ("public"."fiscal_agent_listings" "l"
     JOIN "public"."users" "u" ON (("l"."owner_user_id" = "u"."id")))
  WHERE ("u"."user_id" = "auth"."uid"()))) OR "public"."is_super_admin"()));



CREATE POLICY "Seekers can send inquiries" ON "public"."sponsorship_inquiries" FOR INSERT WITH CHECK (("public"."has_basic_membership"() AND ("listing_id" IN ( SELECT "l"."id"
   FROM "public"."fiscal_agent_listings" "l"
...
CREATE POLICY "Super admins can read all billing customers" ON "public"."billing_customers" FOR SELECT USING ("public"."is_super_admin"());



CREATE POLICY "Super admins can read all grant comments" ON "public"."grant_comments" FOR SELECT USING ("public"."is_super_admin"());



CREATE POLICY "Super admins can read all memberships" ON "public"."user_memberships" FOR SELECT USING ("public"."is_super_admin"());



CREATE POLICY "Super admins can read all notifications" ON "public"."notifications" FOR SELECT USING ("public"."is_super_admin"());



CREATE POLICY "Super admins can read all subscriptions" ON "public"."subscriptions" FOR SELECT USING ("public"."is_super_admin"());



CREATE POLICY "Super admins can update any listing" ON "public"."fiscal_agent_listings" FOR UPDATE USING ("public"."is_super_admin"()) WITH CHECK ("public"."is_super_admin"());
...
CREATE POLICY "Users can insert budget items for their grants" ON "public"."budget_items" FOR INSERT WITH CHECK (("public"."has_basic_membership"() AND ("grant_id" IN ( SELECT "gr"."id"
   FROM ("public"."grant_record" "gr"
     JOIN "public"."users" "u" ON (("gr"."user_id" = "u"."id")))
  WHERE ("u"."user_id" = "auth"."uid"())))));
...
CREATE POLICY "Users can insert expenses for their grants" ON "public"."expenses" FOR INSERT WITH CHECK (("public"."has_basic_membership"() AND ("grant_id" IN ( SELECT "gr"."id"
   FROM ("public"."grant_record" "gr"
     JOIN "public"."users" "u" ON (("gr"."user_id" = "u"."id")))
  WHERE ("u"."user_id" = "auth"."uid"())))));
...
CREATE POLICY "Users can insert their own grants" ON "public"."grant_record" FOR INSERT WITH CHECK (("public"."has_basic_membership"() AND ("user_id" IN ( SELECT "users"."id"
   FROM "public"."users"
  WHERE ("users"."user_id" = "auth"."uid"())))));



CREATE POLICY "Users can insert their own receipts" ON "public"."receipts" FOR INSERT WITH CHECK (("public"."has_basic_membership"() AND ("user_id" IN ( SELECT "users"."id"
   FROM "public"."users"
  WHERE ("users"."user_id" = "auth"."uid"())))));



CREATE POLICY "Users can insert their own user record" ON "public"."users" FOR INSERT WITH CHECK ((("auth"."uid"() = "user_id") AND (("role")::"text" = 'grantee'::"text") AND ("is_active" = true)));
...
CREATE POLICY "Users can update budget items for their grants" ON "public"."budget_items" FOR UPDATE USING (("public"."has_basic_membership"() AND (("tenant_id" = "public"."current_tenant_id"()) AND ("grant_id" IN ( SELECT "gr"."id"
   FROM ("public"."grant_record" "gr"
     JOIN "public"."users" "u" ON (("gr"."user_id" = "u"."id")))
  WHERE ("u"."user_id" = "auth"."uid"()))))));
...
CREATE POLICY "Users can update expenses for their grants" ON "public"."expenses" FOR UPDATE USING (("public"."has_basic_membership"() AND (("tenant_id" = "public"."current_tenant_id"()) AND ("grant_id" IN ( SELECT "gr"."id"
   FROM ("public"."grant_record" "gr"
     JOIN "public"."users" "u" ON (("gr"."user_id" = "u"."id")))
  WHERE ("u"."user_id" = "auth"."uid"()))))));
...
CREATE POLICY "Users can update their own grants" ON "public"."grant_record" FOR UPDATE USING (("public"."has_basic_membership"() AND (("tenant_id" = "public"."current_tenant_id"()) AND ("user_id" IN ( SELECT "users"."id"
   FROM "public"."users"
  WHERE ("users"."user_id" = "auth"."uid"()))))));
...
CREATE POLICY "Users can upload attachments for their grants" ON "public"."grant_attachments" FOR INSERT WITH CHECK (("public"."has_basic_membership"() AND ("grant_id" IN ( SELECT "gr"."id"
   FROM ("public"."grant_record" "gr"
     JOIN "public"."users" "u" ON (("gr"."user_id" = "u"."id")))
  WHERE ("u"."user_id" = "auth"."uid"())))));
...
CREATE POLICY "View full listings with basic access" ON "public"."fiscal_agent_listings" FOR SELECT USING ((("owner_user_id" IN ( SELECT "users"."id"
   FROM "public"."users"
  WHERE ("users"."user_id" = "auth"."uid"()))) OR "public"."has_basic_membership"() OR "public"."is_super_admin"()));
